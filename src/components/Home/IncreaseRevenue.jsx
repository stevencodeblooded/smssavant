            ...
            <div className="px-3 py-14">
                <div className="flex flex-col gap-20">
                    <div className="flex flex-col gap-8">
                        ...
                        <div className=" flex flex-col gap-12 md:flex-row " >
                            <div className="md:w-1/2">
                                <h3 className="text-black bg-amber-300 mb-3 w-fit px-2 py-1 font-semibold rounded-md">Sales</h3>
                                <div className="flex flex-col gap-5">
                                    <h1 className="text-4xl font-bold leading-snug mb-3 capitalize md:text-5xl">Increase company revenue up to 65%</h1>
                                    <p>
                            ...
                            <div className="p-5 bg-slate-300 rounded-md md:w-1/2">
                                <img src={womanPicture} alt="woman-in-office" className="rounded-md md:h-full object-contain"/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-8">
                        ...
                        <div className=" flex flex-col gap-12 md:flex-row " >
                            <div className="md:w-1/2 md:order-2">
                                <h3 className="text-black bg-amber-300 mb-3 w-fit px-2 py-1 font-semibold rounded-md">Marketing</h3>
                                <div className="flex flex-col gap-5">
                                    <h1 className="text-4xl font-bold leading-snug mb-3 capitalize md:text-5xl">Marketing Automation</h1>
                                    <p>
                            ...
                            <div className="p-5 bg-slate-300 rounded-md md:w-1/2 md:order-1">
                                <img src={mobilePhone} alt="woman-in-office" className="rounded-md md:h-full object-contain"/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-8">
                        ...
                        <div className=" flex flex-col gap-12 md:flex-row " >
                            <div className="md:w-1/2">
                                <h3 className="text-black bg-amber-300 mb-3 w-fit px-2 py-1 font-semibold rounded-md">Service</h3>
                                <div className="flex flex-col gap-5">
                                    <h1 className="text-4xl font-bold leading-snug mb-3 capitalize md:text-5xl">Help Desk Software</h1>
                                    <p>
                            ...
                            <div className="p-5 bg-slate-300 rounded-md md:w-1/2">
                                <img src={helpDesk} alt="woman-in-office" className="rounded-md md:h-full object-contain"/>
                            </div>
                        </div>
                    </div>
