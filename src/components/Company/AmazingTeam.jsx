        ...
        <section className="max-w-5xl mx-auto">
            <div className="px-3">
                <div className='flex flex-col gap-16'>
                    <h1 className='text-4xl font-bold leading-snug'>Meet our amazing team</h1>
                    <hr className="border-black mx-4"/>

                    <div className='grid grid-cols-2 gap-4'>
                        <div>
                            <img src={profilePic} alt="" className='rounded-lg' />
                            <div>
                        ...
                        <div>
                            <img src={profilePic2} alt="" className='rounded-lg' />
                             <div>
                    ...
                    <div className='flex flex-col gap-6 bg-teal-950 text-white px-3 py-4 rounded'>
                        <h1 className='text-4xl font-bold leading-snug'>Join our team</h1>
